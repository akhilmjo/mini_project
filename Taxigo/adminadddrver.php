		...
		<h3 style="color:pink;margin-left:48%; margin-top:-2%;">DRIVER REGISTRATION</h3><br />								
      			<form action="driverreg.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<table style="width:100%; cellpadding:5%; margin-left:50%;margin-top:-2%;">
						...
						<tr><td> Date Of Birth<span style="color:red;">*</span>:</td> <td><input  id="demo" type="text" name="dob"style="width:250px;"></td></tr>
						...
						<tr><td> id proof<span style="color:red;">*</span>:</td><td><input name="photo2" type="file" id="ufile2" size="50" required style="margin-left:28%"></td></tr>
						<tr><td> licence no<span style="color:red;">*</span>:</td> <td><input type="text" name="idno1" required></td></tr>
						<tr><td> licence proof<span style="color:red;">*</span>:</td> <td><input name="photo3" type="file" id="ufile3" size="50" required style="margin-left:28%"></td></tr>
						</table>
