		...
		<h3 style="color:pink;margin-left:48%; margin-top:-2%;">VEHICLE REGISTRATION</h3><br />								
      			<form action="#" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<table style="width:100%; cellpadding:5%; margin-left:50%;margin-top:-2%;">
						<tr><td>Vehicle name<span style="color:red;">*</span>:</td> <td><input type="text" name="name" required style="z-index:50px;"></td></tr>
						<tr><td>Registeration number<span style="color:red;">*</span>:</td> <td><input type="text" name="rno" maxlength="10" required></td></tr>
						<tr><td>Vehicle photo<span style="color:red;">*</span>:</td><td><input name="rphoto" type="file" id="ufile" size="50" required style="margin-left:28%"></td></tr>
						<tr><td>Seat number<span style="color:red;">*</span>:</td> <td><input type="text" name="seatno" maxlength="10" required></td></tr>
						<tr><td>Vehicle model<span style="color:red;">*</span>:</td> <td><input type="text" name="vmodel" maxlength="10" required></td></tr>
						<tr><td>Vehicle color<span style="color:red;">*</span>:</td> <td><input type="text" name="vcolor" maxlength="10" required></td></tr>
						<tr><td>Rate/km<span style="color:red;">*</span>:</td> <td><input type="text" name="rate" maxlength="10" required></td></tr>												
