...
<h3 style="color:pink;margin-left:18%; margin-top:-4%;">REGISTRATION</h3><br />
      			...
      			<form action="userreg.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="validateEmail(document.form1.email)">
					<table style="width:100%; cellpadding:5%; margin-left:18%;margin-top:-2%;">
						<tr><td>fristname<span style="color:red;">*</span>:</td> <td><input type="text" name="fname" required></td></tr>
						...
						<tr><td> Email<span style="color:red;">*</span>:</td> <td><input type="text" name="email" onblur="validateEmail(this);" required></td></tr><tr></tr>
						<tr><td> Date Of Birth<span style="color:red;">*</span>:</td> <td><input  id="demo" type="text" name="dob"style="width:169px;"></td></tr>
						<tr><td> phone no<span style="color:red;">*</span>:</td> <td><input type="text" name="phno" onblur="phonenumber(document.form1.phno)"></td></tr>
						<tr><td>photo<span style="color:red;">*</span>:</td><td><input name="photo" type="file" id="ufile" size="50" required/></td></tr><tr></tr>												
						...
						<tr><td> id proof no<span style="color:red;">*</span>:</td> <td><input type="text" name="idno" required></td></tr>
						<tr><td> id proof<span style="color:red;">*</span>:</td> <td><input name="photo2" type="file" id="ufile1" size="50" required/></td></tr>
						</table>
						<table style="width:-5%; margin-left:80%;margin-top:-5%;"><tr><td><button class="btn btn-primary btn-block" name="submit"  >Register</button></td></tr></table>	
                    </form>
